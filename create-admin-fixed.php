...
// Script corrigido para criar usuário Super Admin
// Execute: php create-admin-fixed.php

echo "🔧 Criando usuário Super Admin (versão corrigida)...\n";
...
// 3. Script para criar o usuário (corrigido)
$script = '
use App\Models\User;
use App\Models\Role;
