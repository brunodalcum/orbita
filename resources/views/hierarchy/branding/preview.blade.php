...
<head>
    ...
    <style>
        ...
        @import url('https://fonts.googleapis.com/css2?family={{ urlencode($previewBranding['font_family'] ?? 'Inter') }}:wght@300;400;500;600;700&display=swap');
...
<body class="p-4">
    ...
    <div class="mt-6 text-center">
        <p class="text-sm secondary-text">
            Preview do Branding - {{ now()->format('d/m/Y H:i') }}
        </p>
    </div>
</body>
</html>
