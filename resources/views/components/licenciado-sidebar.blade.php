<aside class="w-64 text-white min-h-screen flex flex-col shadow-xl" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
    ...
    <div class="p-6 border-b border-white/20">
        <div class="flex items-center">
            ...
            <div>
                <h2 class="font-bold text-lg">{{ config('app.name', 'DSPay') }}</h2>
    ...
    <nav class="flex-1 p-4 space-y-2">
        <!-- Dashboard -->
        <a href="{{ route('licenciado.dashboard') }}" 
           class="sidebar-link flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ $currentRoute === 'licenciado.dashboard' ? 'bg-white/20 shadow-md' : 'hover:bg-white/10' }}">
        ...
        <a href="{{ route('licenciado.relatorios') }}" 
           class="sidebar-link flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ $currentRoute === 'licenciado.relatorios' ? 'bg-white/20 shadow-md' : 'hover:bg-white/10' }}">
        ...
        <!-- Perfil -->
        <a href="{{ route('licenciado.perfil') }}" 
           class="sidebar-link flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ $currentRoute === 'licenciado.perfil' ? 'bg-white/20 shadow-md' : 'hover:bg-white/10' }}">
        ...
        <a href="{{ route('licenciado.suporte') }}" 
           class="sidebar-link flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ $currentRoute === 'licenciado.suporte' ? 'bg-white/20 shadow-md' : 'hover:bg-white/10' }}">
