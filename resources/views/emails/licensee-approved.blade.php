...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">
                Parabéns, {{ $licenciado->razao_social }}!
            </div>
            ...
            <div class="contract-details">
                ...
                @if($licenciado->nome_fantasia && $licenciado->nome_fantasia !== $licenciado->razao_social)
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $approval_date->format('d/m/Y H:i') }}</span>
                </div>
                <div class="detail-row">
        ...
        <div class="footer">
            ...
            <p style="margin-top: 20px; font-size: 12px; color: #999;">
                Email enviado em {{ now()->format('d/m/Y H:i') }} | Contrato #{{ $contract->id }}
            </p>
        </div>
    </div>
</body>
