                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="pt-4 border-t border-gray-200">
                                <a href="{{ route('dashboard.agenda.show', $reminder->agenda->id) }}" class="text-primary hover:text-blue-800 font-medium">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('reminders.create') }}" class="w-full bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary-dark transition-colors text-sm text-center block">
