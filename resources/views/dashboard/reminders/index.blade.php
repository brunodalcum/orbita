        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                                ...
                                <div class="p-6 space-y-6">
                                            ...
                                            <div class="bg-white rounded-lg p-4 border border-gray-200">
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <div>
                                                        <div class="space-y-2 text-sm">
                                                            ...
                                                            @if($reminder->agenda->meet_link)
                                                                <div>
                                                                    ...
                                                                    <a href="{{ $reminder->agenda->meet_link }}" target="_blank" class="text-primary hover:text-blue-800 text-xs break-all">
                                                        ...
                                                        <div class="mt-3">
                                                            <a href="{{ route('dashboard.agenda.show', $reminder->agenda->id) }}" class="text-primary hover:text-blue-800 text-sm font-medium">
                                    ...
                                    <div class="border-t border-gray-200 pt-6">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <a href="{{ route('reminders.show', $reminder->id) }}" class="text-primary hover:text-blue-800 text-sm font-medium">
                                                <i class="fas fa-external-link-alt mr-1"></i>
                                                Ver Página Completa
                                            </a>
                                        </div>
            ...
            @else
                <div class="p-12 text-center">
                    ...
                    <a href="{{ route('reminders.create') }}" class="bg-primary text-white px-6 py-3 rounded-lg hover:bg-primary-dark transition-colors font-medium">
                        <i class="fas fa-plus mr-2"></i>
