                        ...
                        <div class="flex-1">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                <div class="flex items-center p-3 bg-blue-50 rounded-lg">
                                    <i class="fas fa-clock text-primary mr-3 text-lg"></i>
                                    <div>
                                        <p class="text-sm text-primary font-medium">Horário</p>
                                ...
                                ${agenda.participantes && agenda.participantes.length > 0 ? `
                                    <div class="flex items-center p-3 bg-indigo-50 rounded-lg">
                                        <i class="fas fa-users text-primary mr-3 text-lg"></i>
                                        <div>
                                            <p class="text-sm text-primary font-medium">Participantes</p>
