            ...
            @else
                <div class="p-12 text-center">
                    ...
                    <div class="flex items-center justify-center space-x-4">
                        <a href="{{ route('dashboard.agenda.create') }}" class="bg-primary text-white px-6 py-3 rounded-lg hover:bg-primary-dark transition-colors font-medium">
            ...
            <div class="p-6">
                <form id="agendaForm">
                    ...
                    <div class="flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                        ...
                        <button type="button" onclick="saveAgenda()" class="px-6 py-3 bg-primary text-white rounded-lg hover:bg-primary-dark font-medium">
        ...
        <div class="p-8">
            ...
            <form id="editAgendaForm" method="POST">
                ...
                <div class="flex space-x-4 mt-8">
                    ...
                    <button type="submit" 
                            class="flex-1 px-6 py-3 bg-primary text-white rounded-xl font-medium hover:bg-primary-dark transition-colors">
                        <i class="fas fa-save mr-2"></i>
                        Salvar Alterações
                    </button>
                </div>
