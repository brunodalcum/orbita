                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label for="nome" class="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                            <i class="fas fa-user text-primary mr-2"></i>Nome Completo *
                        </label>
                    ...
                    <div class="space-y-2">
                        <label for="origem" class="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                            <i class="fas fa-tag text-primary mr-2"></i>Origem
                        </label>
            ...
            <form id="assignForm" class="space-y-4">
                <div class="space-y-2">
                    <label for="licenciado_id" class="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                        <i class="fas fa-user text-primary mr-2"></i>Licenciado
                    </label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-xl border border-blue-200">
                            <label class="block text-sm font-semibold text-primary mb-2 flex items-center">
                                <i class="fas fa-user text-primary mr-2"></i>Nome
                            </label>
