                ...
                <div class="container mx-auto px-4 py-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                            ...
                            <div class="space-y-4">
                                <button onclick="openQuickEmailModal('lead')" class="w-full bg-blue-50 hover:bg-blue-100 text-primary px-4 py-3 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center">
