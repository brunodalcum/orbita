                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            @if(auth()->user()->hasPermission('users.update'))
                                <a href="{{ route('users.edit', $user) }}" 
                                   class="bg-primary text-white px-6 py-2 rounded-lg hover:bg-primary transition-colors flex items-center space-x-2">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-white rounded-lg shadow-sm p-6">
                                ...
                                <div class="space-y-3">
                                    @if(auth()->user()->hasPermission('users.update'))
                                        <a href="{{ route('users.edit', $user) }}" 
                                           class="w-full flex items-center justify-center px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary transition-colors">
