            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    ...
                    <div class="text-lg font-semibold flex items-center">
                        <i class="fas fa-exclamation-triangle mr-2"></i>❌ {{ ucfirst(str_replace('_', ' ', $contract->status)) }}
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-4xl mx-auto px-6 py-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 mb-8 text-center">
            ...
            <div class="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
                <div class="flex items-center justify-center space-x-4 text-red-800">
                    ...
                    <div class="text-center">
                        <div class="text-2xl font-bold">{{ ucfirst(str_replace('_', ' ', $contract->status)) }}</div>
                        <div class="text-sm">Status Atual</div>
                    </div>
                    <div class="w-px h-12 bg-red-300"></div>
                    <div class="text-center">
                        <div class="text-2xl font-bold">{{ $contract->created_at->format('d/m/Y') }}</div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <span class="font-medium text-gray-900">{{ $contract->contract_signed_at->format('d/m/Y H:i') }}</span>
                    </div>
                    @endif
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <a href="mailto:contrato@dspay.com.br?subject=Problema com Contrato #{{ str_pad($contract->id, 6, '0', STR_PAD_LEFT) }}" 
                ...
                @if($contract->status === 'contrato_assinado')
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                ...
                <a href="https://wa.me/5511999999999?text=Olá, preciso de ajuda com o contrato #{{ str_pad($contract->id, 6, '0', STR_PAD_LEFT) }}" 
                   target="_blank"
