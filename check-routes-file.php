...
// Script para verificar arquivo de rotas
// Execute: php check-routes-file.php

echo "🔍 Verificando arquivo de rotas...\n";
...
echo "✅ Se houver problemas, execute: php fix-500-definitive.php\n";
