...
// Script específico para corrigir erro 419 (CSRF Token Mismatch)
// Execute: php fix-419-csrf.php
...
// 7. Verificar se a tabela de sessões existe (se usando database)
echo "📊 Verificando configuração de sessões...\n";
$sessionConfig = shell_exec('php artisan config:show session.driver 2>&1');
echo "Driver de sessão atual: $sessionConfig\n";
...
// 10. Criar arquivo de teste para verificar CSRF
