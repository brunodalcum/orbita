...
// Script simples para corrigir erro 500
// Execute: php fix-500-simple.php

echo "🚨 CORREÇÃO SIMPLES - ERRO 500...\n";
...
// 2. Limpar cache básico (sem comandos que travam)
echo "\n🗑️ Limpando cache básico...\n";
...
echo "✅ Comandos simples para evitar travamento\n";
