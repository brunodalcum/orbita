    ...
    <div class="min-h-screen p-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm border p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900"><?php echo e($template->name); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border p-6 mb-6">
                ...
                <div class="border rounded-lg p-4 bg-gray-50 max-h-96 overflow-y-auto">
                    <div class="prose max-w-none text-sm">
                        <?php echo Str::limit(strip_tags($previewContent), 500); ?>

                        <?php if(strlen(strip_tags($previewContent)) > 500): ?>
            ...
            <div class="bg-white rounded-lg shadow-sm border p-6">
                ...
                <form method="POST" action="<?php echo e(route('contracts.generate.step3')); ?>">
                    <?php echo csrf_field(); ?>
            ...
            <div class="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <div class="text-sm text-yellow-700">
                    <p><strong>Licenciado ID:</strong> <?php echo e($licenciado->id); ?></p>
                    <p><strong>Template ID:</strong> <?php echo e($template->id); ?></p>
                    <p><strong>CSRF Token:</strong> <?php echo e(csrf_token()); ?></p>
                    <p><strong>Route:</strong> <?php echo e(route('contracts.generate.step3')); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/contracts/generate/step2-simple.blade.php ENDPATH**/ ?>