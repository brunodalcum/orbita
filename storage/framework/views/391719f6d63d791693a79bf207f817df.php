                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm"><?php echo e(\Carbon\Carbon::today()->locale('pt_BR')->isoFormat('dddd, D [de] MMMM [de] YYYY')); ?></p>
                        </div>
                    </div>
                    <a href="<?php echo e(route('licenciado.agenda.calendar')); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                        Ver calendário <i class="fas fa-arrow-right ml-1"></i>
                    </a>
                </div>
                
                <?php if($todayAgendas->count() > 0): ?>
                    <div class="space-y-4">
                        <?php $__currentLoopData = $todayAgendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="group relative border-2 <?php echo e($statusColor); ?> rounded-xl p-4 hover:shadow-lg transition-all duration-200 cursor-pointer"
                                 onclick="showAgendaDetails(<?php echo e(json_encode($agenda)); ?>)">
                                
                                <!-- Indicador de Status -->
                                <div class="absolute -left-1 top-4 w-3 h-3 rounded-full
                                    <?php echo e($agenda->status_aprovacao === 'confirmado' || $agenda->status_aprovacao === 'aprovada' ? 'bg-green-500' : 
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        ...
                                        <div class="flex items-center mb-2">
                                            <div class="w-12 h-12 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex items-center justify-center mr-3">
                                                <span class="text-sm font-bold text-gray-700"><?php echo e($startTime->format('H:i')); ?></span>
                                            </div>
                                            <div class="flex-1">
                                                <h4 class="text-lg font-semibold text-gray-900 mb-1"><?php echo e($agenda->titulo); ?></h4>
                                                <div class="flex items-center text-sm text-gray-600">
                                                    <i class="fas fa-clock mr-1"></i>
                                                    <span><?php echo e($startTime->format('H:i')); ?> - <?php echo e($endTime->format('H:i')); ?></span>
                                                    <span class="mx-2">•</span>
                                                    <span><?php echo e($startTime->diffInMinutes($endTime)); ?> min</span>
                                        ...
                                        <?php if($agenda->descricao): ?>
                                            <p class="text-gray-600 text-sm line-clamp-2 mb-2"><?php echo e($agenda->descricao); ?></p>
                                        <?php endif; ?>
                                        
                                        <!-- Participantes -->
                                        <?php if($agenda->destinatario): ?>
                                            <div class="flex items-center text-sm text-gray-500">
                                                <i class="fas fa-user mr-1"></i>
                                                <span>Com: <?php echo e($agenda->destinatario->name); ?></span>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <!-- Status Badge -->
                                    <div class="ml-4">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($statusBadgeColor); ?>">
                                            <?php if($agenda->status_aprovacao === 'confirmado' || $agenda->status_aprovacao === 'aprovada'): ?>
                                                <i class="fas fa-check mr-1"></i>Confirmado
                                            <?php elseif($agenda->status_aprovacao === 'pendente'): ?>
                                                <i class="fas fa-clock mr-1"></i>Pendente
                                            <?php elseif($agenda->status_aprovacao === 'cancelado' || $agenda->status_aprovacao === 'recusada'): ?>
