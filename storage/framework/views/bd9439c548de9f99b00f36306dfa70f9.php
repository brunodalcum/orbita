...
<?php endif; ?>
                    ...
                    <nav class="flex mb-8" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-2">
                            <li class="inline-flex items-center">
                                <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center text-sm font-medium text-gray-600 hover:text-blue-600 transition-colors">
                        ...
                        <form id="configForm" enctype="multipart/form-data" class="space-y-8">
                            ...
                            <div class="group">
                                ...
                                <input type="text" 
                                       id="nome_sistema" 
                                       name="nome_sistema" 
                                       value="<?php echo e($configuracoes['nome_sistema'] ?? ''); ?>"
                            ...
                            <div class="group">
                                ...
                                <input type="email" 
                                       id="email_sistema" 
                                       name="email_sistema" 
                                       value="<?php echo e($configuracoes['email_sistema'] ?? ''); ?>"
                                       class="form-input w-full px-6 py-4 rounded-xl text-lg"
                            ...
                            <div class="group">
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo e($configuracoes['telefone_sistema'] ?? ''); ?>"
                                       class="form-input w-full px-6 py-4 rounded-xl text-lg"
                            ...
                            <div class="group">
                                ...
                                <input type="text" 
                                       id="cnpj_sistema" 
                                       name="cnpj_sistema" 
                                       value="<?php echo e($configuracoes['cnpj_sistema'] ?? ''); ?>"
                                       class="form-input w-full px-6 py-4 rounded-xl text-lg"
    ...
    <script>
        ...
        function saveConfiguracoes() {
            ...
            fetch('<?php echo e(route("configuracoes.update")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/configuracoes.blade.php ENDPATH**/ ?>