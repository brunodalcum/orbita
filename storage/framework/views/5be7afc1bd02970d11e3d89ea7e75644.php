                    ...
                    <div class="px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Total de <?php echo e($operacoes->count()); ?> operações cadastradas</p>
                            </div>
                            <button 
                                onclick="openModal()" 
                                            ...
                                            <div class="flex items-start justify-between mb-4">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-3">
                                                        ...
                                                        <p class="text-sm text-gray-500">ID: #<?php echo e($operacao->id); ?></p>
                                                    </div>
                                                </div>
                                                <div class="flex items-center space-x-1">
                                                    <button 
                                                        onclick="editOperacao(<?php echo e($operacao->id); ?>, '<?php echo e($operacao->nome); ?>', '<?php echo e($operacao->adquirente); ?>')"
                                                    ...
                                                    <button 
                                                        onclick="openPlanosModal(<?php echo e($operacao->id); ?>, '<?php echo e($operacao->nome); ?>')"
                                                    ...
                                                    <button 
                                                        onclick="deleteOperacao(<?php echo e($operacao->id); ?>, '<?php echo e($operacao->nome); ?>')"
                                            ...
                                            <div class="space-y-3">
                                                <div class="flex items-center p-3 bg-blue-50 rounded-lg">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm font-semibold text-gray-800"><?php echo e($operacao->adquirente); ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex items-center p-3 bg-green-50 rounded-lg">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm font-semibold text-gray-800"><?php echo e($operacao->created_at->format('d/m/Y')); ?></p>
                                                        <p class="text-xs text-gray-500"><?php echo e($operacao->created_at->format('H:i')); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-4 pt-4 border-t border-gray-100">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <span class="text-xs text-gray-500">
                                                        <?php echo e($operacao->updated_at->diffForHumans()); ?>
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/operacoes.blade.php ENDPATH**/ ?>