    ...
    <div class="container">
        ...
        <div class="action-buttons">
            ...
            <div class="quick-actions">
                <a href="<?php echo e(url('/agenda/confirmar/' . ($agenda_id ?? '1') . '?status=confirmado&email=' . urlencode($email ?? 'teste@exemplo.com'))); ?>" 
                   class="quick-action confirm-action">✅ Confirmar Agora</a>
                <a href="<?php echo e(url('/agenda/confirmar/' . ($agenda_id ?? '1') . '?status=recusado&email=' . urlencode($email ?? 'teste@exemplo.com'))); ?>" 
        ...
        <div class="buttons-container">
            ...
            <a href="mailto:?subject=Reunião pendente&body=Marquei como pendente minha participação na reunião: <?php echo e($titulo ?? 'Reunião'); ?>" 
        ...
        <div class="footer">
            ...
            <small>Status pendente registrado em <?php echo e(date('d/m/Y H:i')); ?></small>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/agenda/pendente.blade.php ENDPATH**/ ?>