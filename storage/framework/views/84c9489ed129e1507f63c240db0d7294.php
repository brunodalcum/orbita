...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">
                Olá, <strong><?php echo e($licenciado->razao_social); ?></strong>!
            </div>
            ...
            <div class="contract-details">
                ...
                <?php if($licenciado->nome_fantasia): ?>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e($contract->sent_at->format('d/m/Y H:i')); ?></span>
                </div>
            </div>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e($signature_url); ?>" class="button">
        ...
        <div class="footer">
            ...
            <p style="margin-top: 15px; font-size: 12px; color: #999;">
                Email enviado em <?php echo e(now()->format('d/m/Y H:i')); ?>
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/emails/contract-sent.blade.php ENDPATH**/ ?>