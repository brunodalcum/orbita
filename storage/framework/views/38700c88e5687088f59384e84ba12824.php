...
<head>
    ...
    <title>Contrato <?php echo e(str_pad($contract->id, 6, '0', STR_PAD_LEFT)); ?> - <?php echo e($contract->licenciado->razao_social); ?></title>
...
<body class="bg-gray-50 min-h-screen" x-data="contractSteps(<?php echo e($contract->id); ?>, '<?php echo e($contract->status); ?>')" x-init="init()">
    <!-- Toast Container -->
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">
                            Contrato #<?php echo e(str_pad($contract->id, 6, '0', STR_PAD_LEFT)); ?>

                        </h1>
                        <div class="flex items-center space-x-4 mt-1">
                            <p class="text-sm text-gray-600"><?php echo e($contract->licenciado->razao_social); ?></p>
                            <span class="text-gray-400">•</span>
                            <p class="text-sm text-gray-600"><?php echo e($contract->licenciado->cnpj_cpf ?? 'N/A'); ?></p>
                        </div>
                    </div>
                </div>
                                ...
                                <template x-if="step.id === 1">
                                    <div class="bg-white rounded-lg p-3 border">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div class="flex-1">
                                                <p class="font-medium text-gray-900"><?php echo e($contract->licenciado->razao_social); ?></p>
                                                <p class="text-sm text-gray-600"><?php echo e($contract->licenciado->cnpj_cpf ?? 'N/A'); ?></p>
                                                <p class="text-xs text-gray-500"><?php echo e($contract->licenciado->email ?? 'N/A'); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </template>
...
</html><?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/contracts/show.blade.php ENDPATH**/ ?>