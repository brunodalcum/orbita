    ...
    <div class="max-w-6xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-8">
            <div class="flex items-center mb-6">
                <img src="<?php echo e(asset('images/dspay-logo.png')); ?>" alt="dspay" class="h-8 w-auto mr-4">
            ...
            <div class="mb-6">
                <h2 class="text-lg font-semibold text-gray-800 mb-4">Emails Encontrados (<?php echo e(count($emails)); ?>)</h2>
            ...
            <div class="flex space-x-4">
                <a href="<?php echo e(route('login')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                    Voltar ao Login
                </a>
                <a href="<?php echo e(route('password.request')); ?>" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors">
                    Testar Recuperação
                </a>
            </div>
        </div>
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/emails/log.blade.php ENDPATH**/ ?>