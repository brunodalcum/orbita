...
<?php endif; ?>
                                    ...
                                    <select name="licenciado_id" id="licenciado_id" required
                                        ...
                                        <?php $__currentLoopData = $licenciados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $licenciado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($licenciado->id); ?>" 
                                                    data-info="<?php echo e(json_encode([
                                                        'id' => $licenciado->id,
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('📊 Total de licenciados disponíveis:', <?php echo e($licenciados->count()); ?>);
        });
    </script>
</body>
</html>
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/contracts/generate/index.blade.php ENDPATH**/ ?>