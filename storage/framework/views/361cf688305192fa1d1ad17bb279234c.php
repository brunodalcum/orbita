...
<head>
    ...
    <title>Recuperar Senha - dspay</title>
    ...
    <div class="w-full max-w-sm">
        ...
        <div class="login-card rounded-lg p-8">
            ...
            <div class="text-center mb-8">
                <!-- Logo dspay PNG -->
                <div class="mb-6">
                    <img src="<?php echo e(asset('images/dspay-logo.png')); ?>" alt="dspay" class="h-12 w-auto mx-auto">
                </div>
                
                <h1 class="text-xl font-semibold text-gray-800 mb-1">Recuperar Senha</h1>
                <p class="text-sm text-gray-600">Digite seu email para receber o link de recuperação</p>
            </div>
            ...
            <?php if(session('status')): ?>
                <div class="mb-6 p-3 bg-green-50 border border-green-200 rounded-md">
                    <p class="text-green-700 text-sm"><?php echo e(session('status')); ?></p>
                </div>
            <?php endif; ?>
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>