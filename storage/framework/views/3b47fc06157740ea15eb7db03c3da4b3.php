                    ...
                    <a href="<?php echo e(route($item['route'])); ?>" 
                       class="flex items-center px-4 py-3 text-white rounded-lg transition-all duration-200 <?php echo e($item['is_active'] ? 'bg-white/20 border-l-4 border-white' : 'hover:bg-white/10'); ?>">
                        ...
                        <?php if(count($item['submenu']) > 0): ?>
                            <i class="fas fa-chevron-down ml-auto text-xs transition-transform duration-200 chevron-icon" id="chevron-<?php echo e($loop->index); ?>"></i>
                        <?php endif; ?>
                    </a>

                    <!-- Submenu -->
                    <?php if(count($item['submenu']) > 0): ?>
                        <div class="submenu ml-4 mt-2 space-y-1 hidden" id="submenu-<?php echo e($loop->index); ?>">
