...
<?php $__env->startSection('subtitle', 'Acompanhe suas comissões e pagamentos'); ?>
        ...
        <div class="stat-card green">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold">R$ <?php echo e(number_format($comissoes->comissao_mes, 2, ',', '.')); ?></p>
        ...
        <div class="stat-card orange">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold">R$ <?php echo e(number_format($comissoes->comissao_pendente, 2, ',', '.')); ?></p>
        ...
        <div class="stat-card blue">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold">R$ <?php echo e(number_format($comissoes->comissao_paga, 2, ',', '.')); ?></p>
        ...
        <div class="stat-card purple">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($comissoes->proximo_pagamento->format('d/m')); ?></p>
                    <p class="text-cyan-200 text-xs mt-1"><?php echo e($comissoes->proximo_pagamento->diffForHumans()); ?></p>
                </div>
    ...
    <div class="card">
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    <?php $__currentLoopData = $comissoes->historico; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            <div class="flex items-center">
                                ...
                                <span class="font-medium"><?php echo e($item['mes']); ?>/2024</span>
                            </div>
                        </td>
                        <td>
                            <span class="font-semibold text-green-600 text-lg">R$ <?php echo e(number_format($item['valor'], 2, ',', '.')); ?></span>
                        </td>
                        <td>
                            <span class="status-badge <?php echo e($item['status'] == 'pago' ? 'ativo' : 'pendente'); ?>">
                        ...
                        <td>
                            <?php if($item['status'] == 'pago'): ?>
                                <div>
                                    <p class="font-medium">05/<?php echo e($item['mes'] == 'Janeiro' ? '02' : ($item['mes'] == 'Fevereiro' ? '03' : '04')); ?>/2024</p>
                                    <p class="text-sm text-gray-500">Transferência bancária</p>
                                </div>
                            <?php else: ?>
                                <span class="text-gray-500"><?php echo e($comissoes->proximo_pagamento->format('d/m/Y')); ?></span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if($item['status'] == 'pago'): ?>
...
<?php echo $__env->make('layouts.licenciado', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/licenciado/comissoes.blade.php ENDPATH**/ ?>