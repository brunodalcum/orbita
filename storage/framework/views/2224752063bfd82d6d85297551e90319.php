...
<?php endif; ?>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border">
                        <div class="p-6 border-b">
                            ...
                            <div class="mt-3 flex items-center space-x-4 text-xs text-gray-500">
                                ...
                                <span class="text-gray-400">• Mostrando todos os licenciados cadastrados (<?php echo e($licenciados->count()); ?>)</span>
                            </div>
                        </div>

                        <div class="p-6">
                            <form method="POST" action="<?php echo e(route('contracts.generate.step1')); ?>">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <select name="licenciado_id" id="licenciado_id" required
                                        ...
                                        <?php $__currentLoopData = $licenciados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $licenciado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($licenciado->id); ?>">
                                                <?php echo e($licenciado->razao_social ?: $licenciado->nome_fantasia); ?> 
                                                (<?php echo e($licenciado->cnpj_cpf); ?>) 
                                                - <?php echo e(ucfirst($licenciado->status)); ?>
    ...
    <script>
        ...
        const licenciados = <?php echo json_encode($licenciados->keyBy('id'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/contracts/generate/index-simple.blade.php ENDPATH**/ ?>