...
<?php $__env->startSection('subtitle', 'Acompanhe suas vendas e performance'); ?>
...
<div class="space-y-6">
        ...
        <div class="stat-card green">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold">R$ <?php echo e(number_format($vendas->vendas_hoje, 2, ',', '.')); ?></p>
        ...
        <div class="stat-card blue">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold">R$ <?php echo e(number_format($vendas->vendas_semana, 2, ',', '.')); ?></p>
        ...
        <div class="stat-card orange">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold">R$ <?php echo e(number_format($vendas->vendas_mes, 2, ',', '.')); ?></p>
                    <p class="text-pink-200 text-xs mt-1"><?php echo e($vendas->percentual_meta); ?>% da meta</p>
                </div>
        ...
        <div class="stat-card purple">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold">R$ <?php echo e(number_format($vendas->meta_mes, 2, ',', '.')); ?></p>
    ...
    <div class="card p-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <span class="text-2xl font-bold text-blue-600"><?php echo e($vendas->percentual_meta); ?>%</span>
        </div>
        <div class="w-full bg-gray-200 rounded-full h-4 mb-2">
            <div class="bg-gradient-to-r from-blue-400 to-blue-600 h-4 rounded-full transition-all duration-500" 
                 style="width: <?php echo e($vendas->percentual_meta); ?>%"></div>
        </div>
        <div class="flex justify-between text-sm text-gray-600">
            <span>R$ <?php echo e(number_format($vendas->vendas_mes, 2, ',', '.')); ?> vendido</span>
            <span>R$ <?php echo e(number_format($vendas->meta_mes - $vendas->vendas_mes, 2, ',', '.')); ?> restante</span>
        </div>
    </div>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <td>
                            <div>
                                <p class="font-medium"><?php echo e(now()->format('d/m/Y')); ?></p>
                                <p class="text-sm text-gray-500"><?php echo e(now()->format('H:i:s')); ?></p>
                            </div>
                        </td>
                        <td>
                            <div class="flex items-center">
                    ...
                    <tr>
                        <td>
                            <div>
                                <p class="font-medium"><?php echo e(now()->subHour()->format('d/m/Y')); ?></p>
                                <p class="text-sm text-gray-500"><?php echo e(now()->subHour()->format('H:i:s')); ?></p>
                            </div>
                        </td>
                        <td>
                            <div class="flex items-center">
                    ...
                    <tr>
                        <td>
                            <div>
                                <p class="font-medium"><?php echo e(now()->subHours(2)->format('d/m/Y')); ?></p>
                                <p class="text-sm text-gray-500"><?php echo e(now()->subHours(2)->format('H:i:s')); ?></p>
                            </div>
                        </td>
                        <td>
                            <div class="flex items-center">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const salesChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: <?php echo json_encode(collect($vendas->vendas_por_dia)->pluck('data'), 15, 512) ?>,
            datasets: [{
                label: 'Vendas (R$)',
                data: <?php echo json_encode(collect($vendas->vendas_por_dia)->pluck('valor'), 15, 512) ?>,
...
<?php echo $__env->make('layouts.licenciado', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/licenciado/vendas.blade.php ENDPATH**/ ?>