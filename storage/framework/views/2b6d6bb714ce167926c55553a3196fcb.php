                ...
                <div class="menu-item">
                    ...
                    <a href="<?php echo e(route($item['route'])); ?>" 
                       class="flex items-center px-4 py-3 text-white rounded-lg transition-all duration-200 <?php echo e($item['is_active'] ? 'bg-white/20 border-l-4 border-white' : 'hover:bg-white/10'); ?>">
                        <!-- Ícones SVG inline -->
                        <?php if($item['icon'] === 'fas fa-tachometer-alt'): ?>
                        ...
                        <?php elseif($item['icon'] === 'fas fa-users-cog'): ?>
                            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <?php if(count($item['submenu']) > 0): ?>
                        <div class="submenu ml-4 mt-2 space-y-1">
                            <?php $__currentLoopData = $item['submenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route($subItem['route'])); ?><?php echo e(isset($subItem['action']) ? '#' . $subItem['action'] : ''); ?>" 
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/components/dynamic-sidebar-production.blade.php ENDPATH**/ ?>