...
<?php $__env->startSection('subtitle', 'Gere e baixe relatórios detalhados'); ?>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e(now()->subDay()->format('d/m/Y H:i')); ?></td>
                        <td><span class="status-badge ativo">Pronto</span></td>
                        <td>
                            <button class="text-blue-600 hover:text-blue-800 mr-2">
                                <i class="fas fa-download"></i>
                    ...
                    <tr>
                        ...
                        <td><?php echo e(now()->subDays(5)->format('d/m/Y H:i')); ?></td>
...
<?php echo $__env->make('layouts.licenciado', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/licenciado/relatorios.blade.php ENDPATH**/ ?>