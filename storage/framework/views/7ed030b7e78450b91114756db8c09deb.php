                    ...
                    <div class="px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Total de <?php echo e($planos->count()); ?> planos cadastrados</p>
                            </div>
                            <button 
                        ...
                        <div class="mt-4 p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-600">
                                    <span id="filterResults">Mostrando todos os <?php echo e($planos->count()); ?> planos</span>
                                </span>
                                     ...
                                     <tbody class="bg-white divide-y divide-gray-200">
                                         <?php $__currentLoopData = $planos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plano): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <tr class="hover:bg-gray-50 transition-colors duration-200 plan-row" 
                                                 data-id="<?php echo e($plano->id); ?>"
                                                 data-nome="<?php echo e(strtolower($plano->nome)); ?>"
                                                 data-operacao="<?php echo e($plano->operacao); ?>"
                                                 data-adquirente="<?php echo e(strtolower($plano->adquirente)); ?>"
                                                 data-parceiro="<?php echo e(strtolower($plano->parceiro)); ?>"
                                                 data-comissao-media="<?php echo e($plano->comissao_media ?? 0); ?>"
                                                 data-taxa-debito-visa="<?php echo e($plano->taxas_detalhadas['debito']['visa_master'] ?? 0); ?>"
                                                 data-taxa-debito-elo="<?php echo e($plano->taxas_detalhadas['debito']['elo'] ?? 0); ?>"
                                                 data-taxa-debito-demais="<?php echo e($plano->taxas_detalhadas['debito']['demais'] ?? 0); ?>"
                                                 data-taxa-credito-visa="<?php echo e($plano->taxas_detalhadas['credito_vista']['visa_master'] ?? 0); ?>"
                                                 data-taxa-credito-elo="<?php echo e($plano->taxas_detalhadas['credito_vista']['elo'] ?? 0); ?>"
                                                 data-taxa-credito-demais="<?php echo e($plano->taxas_detalhadas['credito_vista']['demais'] ?? 0); ?>"
                                                 data-comissao-debito-visa="<?php echo e($plano->comissoes_detalhadas['debito']['visa_master'] ?? 0); ?>"
                                                 data-comissao-debito-elo="<?php echo e($plano->comissoes_detalhadas['debito']['elo'] ?? 0); ?>"
                                                 data-comissao-debito-demais="<?php echo e($plano->comissoes_detalhadas['debito']['demais'] ?? 0); ?>"
                                                 data-comissao-credito-visa="<?php echo e($plano->comissoes_detalhadas['credito_vista']['visa_master'] ?? 0); ?>"
                                                 data-comissao-credito-elo="<?php echo e($plano->comissoes_detalhadas['credito_vista']['elo'] ?? 0); ?>"
                                                 data-comissao-credito-demais="<?php echo e($plano->comissoes_detalhadas['credito_vista']['demais'] ?? 0); ?>">
                                                 ...
                                                 <td class="px-6 py-4 whitespace-nowrap">
                                                     <div class="flex items-center">
                                                         ...
                                                         <div>
                                                             <div class="text-sm font-medium text-gray-900"><?php echo e($plano->nome); ?></div>
                                                         </div>
                                                     </div>
                                                 </td>
                                                 <td class="px-6 py-4">
                                                     <div class="text-sm text-gray-900 max-w-xs truncate" title="<?php echo e($plano->descricao); ?>">
                                                         <?php echo e(Str::limit($plano->descricao, 50) ?: 'Sem descrição'); ?>

                                                     </div>
                                                 </td>
                                                 <td class="px-6 py-4 whitespace-nowrap">
                                                     <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                         <?php echo e(number_format($plano->taxa, 2)); ?>%
                                                     </span>
                                                 </td>
                                                 <td class="px-6 py-4 whitespace-nowrap">
                                                     <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                         <?php echo e(number_format($plano->comissao_media ?? 0, 2)); ?>%
                                                     </span>
                                                 </td>
                                                 <td class="px-6 py-4 whitespace-nowrap">
                                                     <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($plano->status === 'ativo' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                         <i class="fas fa-circle mr-1 text-xs"></i>
                                                         <?php echo e(ucfirst($plano->status)); ?>

                                                     </span>
                                                 </td>
                                                 <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                     <?php echo e($plano->created_at->format('d/m/Y H:i')); ?>

                                                 </td>
                                                 <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                                     <div class="flex items-center justify-center space-x-2">
                                                         <button 
                                                             onclick="viewPlan(<?php echo e($plano->id); ?>)"
                                                         ...
                                                         <button 
                                                             onclick="editPlan(<?php echo e($plano->id); ?>)"
                                                         ...
                                                         <button 
                                                             onclick="togglePlanStatus(<?php echo e($plano->id); ?>, '<?php echo e($plano->status); ?>')"
                                                             class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md <?php echo e($plano->status === 'ativo' ? 'text-red-700 bg-red-100 hover:bg-red-200' : 'text-green-700 bg-green-100 hover:bg-green-200'); ?> focus:outline-none focus:ring-2 focus:ring-offset-2 <?php echo e($plano->status === 'ativo' ? 'focus:ring-red-500' : 'focus:ring-green-500'); ?> transition-colors duration-200"
                                                             title="<?php echo e($plano->status === 'ativo' ? 'Desativar' : 'Ativar'); ?>"
                                                         >
                                                             <i class="fas <?php echo e($plano->status === 'ativo' ? 'fa-pause' : 'fa-play'); ?> mr-1"></i>
                                                             <?php echo e($plano->status === 'ativo' ? 'Desativar' : 'Ativar'); ?>

                                                         </button>
                                                         <button 
                                                             onclick="deletePlan(<?php echo e($plano->id); ?>)"
                            ...
                            <div>
                                ...
                                <select id="parceiro" name="parceiro" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    ...
                                    <?php $__currentLoopData = $operacoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operacao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($operacao->nome); ?>"><?php echo e($operacao->nome); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/planos.blade.php ENDPATH**/ ?>