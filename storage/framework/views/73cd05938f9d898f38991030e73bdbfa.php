                    ...
                    <div class="px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Total de <?php echo e($adquirentes->count()); ?> adquirentes cadastrados</p>
                            </div>
                            <button 
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full bg-white border border-gray-200 rounded-lg shadow-sm">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $__currentLoopData = $adquirentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adquirente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                                #<?php echo e($adquirente->id); ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    ...
                                                    <div>
                                                        <div class="text-sm font-medium text-gray-900"><?php echo e($adquirente->nome); ?></div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($adquirente->status === 'ativo' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                    <i class="fas fa-circle mr-1 text-xs"></i>
                                                    <?php echo e(ucfirst($adquirente->status)); ?>

                                                </span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo e($adquirente->created_at->format('d/m/Y H:i')); ?>

                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                                <div class="flex items-center justify-center space-x-2">
                                                    <button 
                                                        onclick="viewAdquirente(<?php echo e($adquirente->id); ?>)"
                                                    ...
                                                    <button 
                                                        onclick="editAdquirente(<?php echo e($adquirente->id); ?>)"
                                                    ...
                                                    <button 
                                                        onclick="toggleAdquirenteStatus(<?php echo e($adquirente->id); ?>, '<?php echo e($adquirente->status); ?>')"
                                                        class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md <?php echo e($adquirente->status === 'ativo' ? 'text-red-700 bg-red-100 hover:bg-red-200' : 'text-green-700 bg-green-100 hover:bg-green-200'); ?> focus:outline-none focus:ring-2 focus:ring-offset-2 <?php echo e($adquirente->status === 'ativo' ? 'focus:ring-red-500' : 'focus:ring-green-500'); ?> transition-colors duration-200"
                                                        title="<?php echo e($adquirente->status === 'ativo' ? 'Desativar' : 'Ativar'); ?>"
                                                    >
                                                        <i class="fas <?php echo e($adquirente->status === 'ativo' ? 'fa-pause' : 'fa-play'); ?> mr-1"></i>
                                                        <?php echo e($adquirente->status === 'ativo' ? 'Desativar' : 'Ativar'); ?>

                                                    </button>
                                                    <button 
                                                        onclick="deleteAdquirente(<?php echo e($adquirente->id); ?>)"
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/adquirentes.blade.php ENDPATH**/ ?>