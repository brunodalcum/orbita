...
:root {
    ...
    /* Cores derivadas */
    --primary-light: <?php echo e($primaryLight); ?>;
    --primary-dark: <?php echo e($primaryDark); ?>;
    --primary-text: <?php echo e($primaryTextColor); ?>;
    
    /* Gradientes */
    --primary-gradient: linear-gradient(135deg, <?php echo e($primaryColor); ?> 0%, <?php echo e($secondaryColor); ?> 100%);
    --accent-gradient: linear-gradient(135deg, <?php echo e($accentColor); ?> 0%, <?php echo e($primaryColor); ?> 100%);
}
...
.form-select:focus {
    border-color: var(--primary-color) !important;
    box-shadow: 0 0 0 0.2rem <?php echo e($primaryLight); ?> !important;
}
...
<?php if($user && $user->isSuperAdminNode()): ?>
    .super-admin-badge {
        background: linear-gradient(135deg, #6B46C1 0%, #9333EA 100%);
        color: white;
    }
<?php elseif($user && $user->node_type === 'operacao'): ?>
    .operacao-badge {
        background: linear-gradient(135deg, #DC2626 0%, #EF4444 100%);
        color: white;
    }
<?php elseif($user && $user->node_type === 'white_label'): ?>
    .white-label-badge {
...
<?php echo $branding['custom_css']; ?>

</style>
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/components/dynamic-branding.blade.php ENDPATH**/ ?>