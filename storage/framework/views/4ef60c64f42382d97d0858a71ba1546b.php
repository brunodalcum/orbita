                                ...
                                <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center space-x-2 mb-1">
                                                    ...
                                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($template->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'); ?>">
                                                ...
                                                <?php if($template->description): ?>
                                                    <p class="text-sm text-gray-600 mb-2">
                                                        <?php echo e(Str::limit($template->description, 120)); ?>
                                                ...
                                                <div class="flex items-center space-x-4 text-sm text-gray-500">
                                                    ...
                                                    <span class="flex items-center">
                                                        ...
                                                        <?php echo e($template->contracts_count ?? 0); ?> contratos
                                                    </span>
                                                    <?php
                                                    ...
                                                    <span class="flex items-center">
                                                        ...
                                                        <?php echo e(count($variables)); ?> variáveis
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex items-center space-x-2 ml-6">
                                        ...
                                        <form action="<?php echo e(route('contract-templates.toggle-status', $template)); ?>" method="POST" class="inline">
                                            ...
                                            <button type="submit" 
                                                    class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-colors <?php echo e($template->is_active ? 'bg-orange-100 hover:bg-orange-200 text-orange-700' : 'bg-emerald-100 hover:bg-emerald-200 text-emerald-700'); ?>">
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/contract-templates/index.blade.php ENDPATH**/ ?>