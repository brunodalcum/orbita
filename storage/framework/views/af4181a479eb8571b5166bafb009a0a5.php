    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                Olá <strong><?php echo e($lead->nome); ?></strong>, sua jornada para o sucesso em meios de pagamento começa agora!
            </p>
        </div>
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/leads/onboarding.blade.php ENDPATH**/ ?>