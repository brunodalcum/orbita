        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm border-b">
                <div class="flex items-center justify-between px-6 py-4">
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(route('dashboard.marketing.campanhas')); ?>" class="text-blue-600 hover:text-blue-800">
                    ...
                    <div class="flex items-center space-x-4">
                        <?php if($campanha->status === 'ativa'): ?>
                            <button onclick="enviarCampanha(<?php echo e($campanha->id); ?>)" class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                                <i class="fas fa-paper-plane mr-2"></i>
                                Enviar Campanha
                            </button>
                        <?php endif; ?>
                        <button onclick="editCampanha(<?php echo e($campanha->id); ?>)" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                <div class="container mx-auto">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100 mb-6">
                        <div class="flex items-center justify-between mb-6">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <h1 class="text-3xl font-bold text-gray-900"><?php echo e($campanha->nome); ?></h1>
                                    <div class="flex items-center space-x-3 mt-2">
                                        ...
                                        <?php elseif($campanha->status === 'concluida'): ?>
                                        ...
                                        <?php if($campanha->tipo === 'lead'): ?>
                                            <span class="px-3 py-1 text-sm font-semibold rounded-full bg-blue-100 text-blue-800">
                                                <i class="fas fa-users mr-1"></i>Campanha para Leads
                                            </span>
                                        <?php elseif($campanha->tipo === 'licenciado'): ?>
                                            <span class="px-3 py-1 text-sm font-semibold rounded-full bg-green-100 text-green-800">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div class="text-center">
                                <div class="text-3xl font-bold text-blue-600"><?php echo e($campanha->total_destinatarios); ?></div>
                                <div class="text-sm text-gray-600">Total de Destinatários</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-bold text-green-600"><?php echo e($campanha->emails_enviados); ?></div>
                                <div class="text-sm text-gray-600">E-mails Enviados</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-bold text-blue-600"><?php echo e($campanha->taxa_abertura); ?>%</div>
                                <div class="text-sm text-gray-600">Taxa de Abertura</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-bold text-purple-600"><?php echo e($campanha->taxa_clique); ?>%</div>
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="text-gray-900 mt-1"><?php echo e($campanha->descricao ?: 'Sem descrição'); ?></p>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-600">Modelo de E-mail</label>
                                    <p class="text-gray-900 mt-1"><?php echo e($campanha->modelo->nome); ?></p>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-600">Data de Criação</label>
                                    <p class="text-gray-900 mt-1"><?php echo e($campanha->created_at->format('d/m/Y H:i')); ?></p>
                                </div>
                                <?php if($campanha->data_inicio): ?>
                                <div>
                                    <label class="block text-sm font-medium text-gray-600">Data de Início</label>
                                    <p class="text-gray-900 mt-1"><?php echo e(\Carbon\Carbon::parse($campanha->data_inicio)->format('d/m/Y H:i')); ?></p>
                                </div>
                                <?php endif; ?>
                                <div>
                                    <label class="block text-sm font-medium text-gray-600">Segmentação</label>
                                    <?php if($campanha->segmentacao && count($campanha->segmentacao) > 0): ?>
                                        <div class="flex flex-wrap gap-2 mt-1">
                                            <?php $__currentLoopData = $campanha->segmentacao; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $segmento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">
                                                    <?php echo e(ucfirst($segmento)); ?>
                                ...
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        <span class="text-sm font-medium text-gray-900">
                                            <?php if($campanha->total_destinatarios > 0): ?>
                                                <?php echo e(round(($campanha->emails_enviados / $campanha->total_destinatarios) * 100, 1)); ?>%
                                            <?php else: ?>
                                                0%
                                            <?php endif; ?>
                                        </span>
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-blue-600 h-2 rounded-full" style="width: <?php echo e($campanha->total_destinatarios > 0 ? ($campanha->emails_enviados / $campanha->total_destinatarios) * 100 : 0); ?>%"></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        <span class="text-sm font-medium text-gray-600">Taxa de Abertura</span>
                                        <span class="text-sm font-medium text-gray-900"><?php echo e($campanha->taxa_abertura); ?>%</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-green-600 h-2 rounded-full" style="width: <?php echo e($campanha->taxa_abertura); ?>%"></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        <span class="text-sm font-medium text-gray-600">Taxa de Clique</span>
                                        <span class="text-sm font-medium text-gray-900"><?php echo e($campanha->taxa_clique); ?>%</span>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-purple-600 h-2 rounded-full" style="width: <?php echo e($campanha->taxa_clique); ?>%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100 mt-6">
                        ...
                        <div class="flex flex-wrap gap-4">
                            <?php if($campanha->status === 'rascunho'): ?>
                                <button onclick="activateCampanha(<?php echo e($campanha->id); ?>)" class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                            ...
                            <?php if($campanha->status === 'ativa'): ?>
                                <button onclick="pauseCampanha(<?php echo e($campanha->id); ?>)" class="bg-yellow-600 hover:bg-yellow-700 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                                    <i class="fas fa-pause mr-2"></i>
                                    Pausar Campanha
                                </button>
                                <button onclick="enviarCampanha(<?php echo e($campanha->id); ?>)" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                                    <i class="fas fa-paper-plane mr-2"></i>
                                    Enviar Campanha
                                </button>
                            <?php endif; ?>
                            ...
                            <?php if($campanha->status === 'pausada'): ?>
                                <button onclick="resumeCampanha(<?php echo e($campanha->id); ?>)" class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                                    <i class="fas fa-play mr-2"></i>
                                    Retomar Campanha
                                </button>
                            <?php endif; ?>
                            
                            <button onclick="duplicateCampanha(<?php echo e($campanha->id); ?>)" class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                                <i class="fas fa-copy mr-2"></i>
                                Duplicar Campanha
                            </button>
                            
                            <button onclick="viewModelo(<?php echo e($campanha->modelo_id); ?>)" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                    ...
                    <!-- Histórico de Envios -->
                    <?php if($campanha->emails_enviados > 0): ?>
                    <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100 mt-6">
                        <h3 class="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e($campanha->updated_at->format('d/m/Y H:i')); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e($campanha->emails_enviados); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <button onclick="reenviarCampanha(<?php echo e($campanha->id); ?>)" class="text-blue-600 hover:text-blue-900">
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/marketing/campanha-detalhes.blade.php ENDPATH**/ ?>