...
<head>
    ...
    <title>Contrato de Licenciamento - <?php echo e($company_name); ?></title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="header">
            ...
            <p><?php echo e($company_name); ?> - Soluções em Pagamentos</p>
        </div>

        <!-- Content -->
        <div class="content">
            <div class="greeting">
                Olá, <strong><?php echo e($licensee_name); ?></strong>!
            </div>
            ...
            <div class="contract-info">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">#<?php echo e(str_pad($contract_id, 6, '0', STR_PAD_LEFT)); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">Data de Geração:</span>
                    <span class="info-value"><?php echo e($contract_created_at); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">Licenciado:</span>
                    <span class="info-value"><?php echo e($licensee_name); ?></span>
                </div>
                <div class="info-item">
            ...
            <div class="attachment-notice">
                ...
                <div style="text-align: center; margin: 30px 0;">
                    <a href="<?php echo e($signature_url); ?>" 
            ...
            <div class="signature">
                Atenciosamente,<br>
                <strong>Equipe <?php echo e($company_name); ?></strong>
            </div>
        </div>
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/emails/contract.blade.php ENDPATH**/ ?>