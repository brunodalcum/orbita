...
<?php endif; ?>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <form action="<?php echo e(route('contract-templates.store')); ?>" method="POST" class="max-w-6xl mx-auto">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                            ...
                            <div>
                                ...
                                <textarea id="description" 
                                          ...
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('description')); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                            ...
                            <div class="p-6 pt-0">
                                <textarea id="content" 
                                          ...
                                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 font-mono text-sm"><?php echo e(old('content')); ?></textarea>
    ...
    <script>
        function templateEditor() {
            return {
                content: <?php echo json_encode(old('content', '')); ?>,
                detectedVariables: [],
                showPreview: false,
                previewContent: '',
                ...
                detectVariables() {
                    ...
                    while ((match = regex.exec(this.content)) !== null) {
                        matches.push('<?php echo e(' + match[1] + '); ?>');
                    }
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/contract-templates/create.blade.php ENDPATH**/ ?>