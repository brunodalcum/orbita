                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-white rounded-lg shadow-sm border p-6">
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            ...
                                            <p class="text-gray-900 text-sm"><?php echo e($licenciado->razao_social ?: $licenciado->nome_fantasia); ?></p>
                                        </div>
                                        
                                        <div>
                                            <label class="text-sm font-medium text-gray-600">Documento</label>
                                            <p class="text-gray-900 text-sm"><?php echo e($licenciado->cnpj_cpf); ?></p>
                                        </div>
                                        
                                        <div>
                                            <label class="text-sm font-medium text-gray-600">Email</label>
                                            <p class="text-gray-900 text-sm"><?php echo e($licenciado->email); ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white rounded-lg shadow-sm border p-6">
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            <label class="text-sm font-medium text-gray-600">Nome</label>
                                            <p class="text-gray-900 text-sm"><?php echo e($template->name); ?></p>
                                        </div>
                                        
                                        <div>
                                            <label class="text-sm font-medium text-gray-600">Versão</label>
                                            <p class="text-gray-900 text-sm">v<?php echo e($template->version); ?></p>
                                        </div>
                                        
                                        <?php if($template->description): ?>
                                        <div>
                                            <label class="text-sm font-medium text-gray-600">Descrição</label>
                                            <p class="text-gray-900 text-sm"><?php echo e($template->description); ?></p>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white rounded-lg shadow-sm border p-6">
                                    ...
                                    <div class="space-y-2">
                                        <?php $__currentLoopData = $contractData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($value): ?>
                                            <div class="flex justify-between items-center text-xs">
                                                <span class="text-gray-600">{{@{{ $key }}@}}</span>
                                                <span class="text-gray-900 font-mono bg-gray-100 px-1 rounded"><?php echo e(Str::limit($value, 15)); ?></span>
                                            </div>
                                            <?php endif; ?>
                        ...
                        <div class="lg:col-span-3">
                            <div class="bg-white rounded-lg shadow-sm border">
                                ...
                                <div class="p-6">
                                    ...
                                    <!-- Generation Form -->
                                    <form method="POST" action="<?php echo e(route('contracts.generate.step3')); ?>" x-data="contractGenerator()">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/contracts/generate/step2.blade.php ENDPATH**/ ?>