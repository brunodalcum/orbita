...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-12 animate-fadeIn">
            ...
            <div class="flex items-center justify-center mb-6">
                <nav class="flex items-center space-x-2 text-sm bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm">
                    <a href="<?php echo e(route('dashboard.agenda')); ?>" class="text-blue-600 hover:text-blue-800 font-medium flex items-center transition-colors">
        ...
        <div class="bg-white rounded-2xl shadow-2xl border-2 border-blue-200 animate-slideUp overflow-hidden">
            ...
            <form action="<?php echo e(route('agenda.store')); ?>" method="POST" id="agendaForm">
                <?php echo csrf_field(); ?>
                                ...
                                <div class="relative">
                                    <select name="licenciado_id" 
                                        ...
                                        <?php $__currentLoopData = $licenciados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $licenciado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($licenciado->id); ?>" 
                                                    data-email="<?php echo e($licenciado->email); ?>"
                                                    <?php echo e(old('licenciado_id') == $licenciado->id ? 'selected' : ''); ?>>
                                                <?php echo e($licenciado->razao_social); ?> - <?php echo e($licenciado->email); ?>
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    <label class="format-card flex items-center p-6 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-blue-300 transition-all bg-gradient-to-r from-white to-blue-50/20">
                                        <input type="radio" 
                                               ...
                                               <?php echo e(old('tipo_reuniao', 'online') == 'online' ? 'checked' : ''); ?>>
                                    ...
                                    <label class="format-card flex items-center p-6 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-green-300 transition-all bg-gradient-to-r from-white to-green-50/20">
                                        <input type="radio" 
                                               ...
                                               <?php echo e(old('tipo_reuniao') == 'presencial' ? 'checked' : ''); ?>>
                                        <div class="ml-4 flex-1">
                                            <div class="flex items-center mb-2">
                                    ...
                                    <label class="format-card flex items-center p-6 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-purple-300 transition-all bg-gradient-to-r from-white to-purple-50/20">
                                        <input type="radio" 
                                               ...
                                               <?php echo e(old('tipo_reuniao') == 'hibrida' ? 'checked' : ''); ?>>
                                        <div class="ml-4 flex-1">
                                            <div class="flex items-center mb-2">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea name="descricao" 
                                          ...
                                          rows="4" 
                                          class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 bg-gradient-to-r from-white to-blue-50/30 hover:border-blue-300 resize-none"
                                          placeholder="Adicione detalhes importantes sobre a reunião, pauta, documentos necessários, etc."><?php echo e(old('descricao')); ?></textarea>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/agenda-create.blade.php ENDPATH**/ ?>