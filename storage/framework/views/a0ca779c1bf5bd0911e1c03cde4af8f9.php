...
<?php endif; ?>
            ...
            <header class="bg-white shadow-sm border-b">
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(route('dashboard.licenciados')); ?>" 
            ...
            <main class="flex-1 overflow-y-auto p-6">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-6">
                                ...
                                <div class="text-white">
                                    <h1 class="text-3xl font-bold mb-2"><?php echo e($licenciado->razao_social); ?></h1>
                                    <p class="text-blue-200 text-lg mb-1"><?php echo e($licenciado->nome_fantasia); ?></p>
                                    <div class="flex items-center space-x-4 text-sm text-blue-300">
                                        <span class="flex items-center">
                                            <i class="fas fa-id-card mr-2"></i>
                                            <?php echo e($licenciado->cnpj_cpf); ?>

                                        </span>
                                        <span class="flex items-center">
                                            <i class="fas fa-calendar mr-2"></i>
                                            <?php echo e($licenciado->data_cadastro_formatada); ?>
                            ...
                            <div class="text-right">
                                <div class="mb-4">
                                    <?php echo $licenciado->status_badge; ?>

                                </div>
                                <div class="text-white/80 text-sm">
                                    <p>Última atualização</p>
                                    <p class="font-semibold"><?php echo e($licenciado->updated_at->format('d/m/Y H:i')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 mb-8 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <!-- Aprovar -->
                            <button onclick="alterarStatus(<?php echo e($licenciado->id); ?>, 'aprovado')" 
                            ...
                            <!-- Reprovar -->
                            <button onclick="alterarStatus(<?php echo e($licenciado->id); ?>, 'recusado')" 
                            ...
                            <!-- Revisar -->
                            <button onclick="alterarStatus(<?php echo e($licenciado->id); ?>, 'em_analise')" 
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="group">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-3 border border-gray-200 group-hover:border-blue-300 transition-colors">
                                        <p class="text-gray-900 font-medium"><?php echo e($licenciado->razao_social); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-3 border border-gray-200 group-hover:border-purple-300 transition-colors">
                                        <p class="text-gray-900 font-medium"><?php echo e($licenciado->nome_fantasia ?: 'Não informado'); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-3 border border-gray-200 group-hover:border-green-300 transition-colors">
                                        <p class="text-gray-900 font-medium font-mono"><?php echo e($licenciado->cnpj_cpf_formatado); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-3 border border-gray-200 group-hover:border-red-300 transition-colors">
                                        <p class="text-gray-900 font-medium"><?php echo e($licenciado->email ?: 'Não informado'); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-3 border border-gray-200 group-hover:border-orange-300 transition-colors">
                                        <p class="text-gray-900 font-medium"><?php echo e($licenciado->telefone_formatado ?: 'Não informado'); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-3 border border-gray-200 group-hover:border-pink-300 transition-colors">
                                        <p class="text-gray-900 font-medium font-mono"><?php echo e($licenciado->cep_formatado); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="md:col-span-2 group">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200 group-hover:border-indigo-300 transition-colors">
                                        <p class="text-gray-900 font-medium">
                                            <?php echo e($licenciado->endereco); ?>, <?php echo e($licenciado->bairro); ?><br>
                                            <span class="text-gray-600"><?php echo e($licenciado->cidade); ?>/<?php echo e($licenciado->estado); ?></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6">
                            <?php if($licenciado->operacoes && count($licenciado->operacoes) > 0): ?>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <?php $__currentLoopData = $licenciado->operacoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operacaoId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            ...
                                            <div class="group relative overflow-hidden bg-gradient-to-br from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 border border-green-200 hover:border-green-300 rounded-xl p-4 transition-all duration-300 transform hover:scale-105">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-4 flex-1">
                                                        <h4 class="font-bold text-gray-900 text-lg"><?php echo e($operacao->nome); ?></h4>
                                                        <?php if($operacao->adquirente): ?>
                                                            <p class="text-sm text-gray-600 mt-1">
                                                                <i class="fas fa-building mr-1"></i>
                                                                <?php echo e($operacao->adquirente); ?>
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <?php $__currentLoopData = $documentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $path = $licenciado->{$tipo . '_path'};
                                        $hasFile = !empty($path);
                                    ?>
                                    
                                    <div class="group relative overflow-hidden bg-gradient-to-br from-<?php echo e($info['color']); ?>-50 to-<?php echo e($info['color']); ?>-100 hover:from-<?php echo e($info['color']); ?>-100 hover:to-<?php echo e($info['color']); ?>-200 border border-<?php echo e($info['color']); ?>-200 hover:border-<?php echo e($info['color']); ?>-300 rounded-xl p-4 transition-all duration-300 transform hover:scale-105">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-<?php echo e($info['color']); ?>-500 to-<?php echo e($info['color']); ?>-600 rounded-lg flex items-center justify-center shadow-lg">
                                                    <i class="<?php echo e($info['icon']); ?> text-white text-lg"></i>
                                                </div>
                                                <div class="ml-4">
                                                    <h4 class="font-bold text-gray-900"><?php echo e($info['nome']); ?></h4>
                                                    <p class="text-sm text-gray-600"><?php echo e($info['desc']); ?></p>
                                                </div>
                                            </div>
                                            
                                            <div class="flex items-center space-x-2">
                                                <?php if($hasFile): ?>
                                                    <a href="<?php echo e(route('licenciados.download', ['licenciado' => $licenciado->id, 'tipo' => $tipo])); ?>" 
                                                       class="group/btn relative overflow-hidden bg-gradient-to-r from-<?php echo e($info['color']); ?>-500 to-<?php echo e($info['color']); ?>-600 hover:from-<?php echo e($info['color']); ?>-600 hover:to-<?php echo e($info['color']); ?>-700 text-white p-2 rounded-lg transition-all duration-300 transform hover:scale-110"
                                                       title="Download">
                                    ...
                                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-200">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <p class="text-lg font-bold text-blue-600"><?php echo e($licenciado->data_cadastro_formatada); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <p class="text-lg font-bold text-green-600"><?php echo e($licenciado->updated_at->format('d/m/Y H:i')); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="group relative overflow-hidden bg-gradient-to-r from-gray-50 to-blue-50 hover:from-blue-50 hover:to-indigo-50 border border-gray-200 hover:border-blue-300 rounded-xl p-4 transition-all duration-300">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 flex-1">
                                                <div class="flex items-center justify-between">
                                                    <span class="text-sm font-bold text-gray-900 capitalize"><?php echo e($followup->tipo); ?></span>
                                                    <span class="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-full"><?php echo e($followup->created_at->format('d/m H:i')); ?></span>
                                                </div>
                                                <p class="text-sm text-gray-700 mt-2 leading-relaxed"><?php echo e($followup->observacao); ?></p>
                                                <?php if($followup->user): ?>
                                                    <p class="text-xs text-gray-500 mt-2 flex items-center">
                                                        <i class="fas fa-user mr-1"></i>
                                                        Por: <?php echo e($followup->user->name); ?>
    ...
    <script>
        const licenciadoId = <?php echo e($licenciado->id); ?>;
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/licenciado-gerenciar.blade.php ENDPATH**/ ?>