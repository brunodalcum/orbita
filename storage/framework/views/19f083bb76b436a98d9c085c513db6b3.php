            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 flex items-center">
                        ...
                        <?php if($isToday && !$hasDateFilter): ?>
                            Compromissos de Hoje
                        <?php elseif($hasDateFilter): ?>
                            Compromissos - <?php echo e(\Carbon\Carbon::parse($dataAtual)->format('d/m/Y')); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div class="text-sm text-gray-600">
                    ...
                    <?php if($isToday && !$hasDateFilter): ?>
                        <strong><?php echo e($agendas->count()); ?></strong> compromisso(s) para <strong>hoje</strong> (<?php echo e(\Carbon\Carbon::parse($dataAtual)->format('d/m/Y')); ?>)
                    <?php elseif($hasDateFilter): ?>
                        <strong><?php echo e($agendas->count()); ?></strong> compromisso(s) para <strong><?php echo e(\Carbon\Carbon::parse($dataAtual)->format('d/m/Y')); ?></strong>
                    <?php else: ?>
                        <strong><?php echo e($agendas->count()); ?></strong> compromisso(s) encontrado(s)
                    <?php endif; ?>
                </div>
                ...
                <div class="p-12 text-center">
                    ...
                    <?php if($isToday && !$hasDateFilter): ?>
                        ...
                        <p class="text-gray-600 mb-6">
                            Você não tem compromissos agendados para hoje (<?php echo e(\Carbon\Carbon::parse($dataAtual)->format('d/m/Y')); ?>).
                            <br>
                            <span class="text-sm">Use o filtro de data acima para ver compromissos de outros dias.</span>
                        </p>
                    <?php elseif($hasDateFilter): ?>
                        <h3 class="text-lg font-medium text-gray-900 mb-2">Nenhum compromisso para <?php echo e(\Carbon\Carbon::parse($dataAtual)->format('d/m/Y')); ?></h3>
                        <p class="text-gray-600 mb-6">
                    ...
                    <div class="flex items-center justify-center space-x-4">
                        <a href="<?php echo e(route('dashboard.agenda.create')); ?>" class="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors font-medium">
