        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <div class="calendar-header">
                    ...
                    <div class="flex items-center space-x-4">
                        <input type="date" id="datePicker" class="date-picker" value="<?php echo e($dataAtual); ?>">
                ...
                <div id="agendaList">
                    <?php $__empty_1 = true; $__currentLoopData = $agendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="agenda-card <?php echo e($agenda->tipo_reuniao); ?>">
                            <div class="flex justify-between items-start mb-6">
                                <div class="flex-1">
                                    <div class="flex items-center gap-3 mb-3">
                                        <div class="w-3 h-3 rounded-full <?php echo e($agenda->tipo_reuniao === 'online' ? 'bg-green-500' : ($agenda->tipo_reuniao === 'presencial' ? 'bg-orange-500' : 'bg-purple-500')); ?> animate-pulse"></div>
                                        <h3 class="text-xl font-bold text-gray-800"><?php echo e($agenda->titulo); ?></h3>
                                    </div>
                                    <?php if($agenda->descricao): ?>
                                        <p class="text-gray-600 mb-4 text-base leading-relaxed"><?php echo e($agenda->descricao); ?></p>
                                    <?php endif; ?>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                        <div class="flex items-center p-3 bg-blue-50 rounded-lg">
                                            ...
                                            <div>
                                                <p class="text-sm text-blue-600 font-medium">Horário</p>
                                                <p class="text-blue-800 font-semibold"><?php echo e($agenda->data_inicio->format('H:i')); ?> - <?php echo e($agenda->data_fim->format('H:i')); ?></p>
                                            </div>
                                        </div>
                                        
                                        <div class="flex items-center p-3 <?php echo e($agenda->tipo_reuniao === 'online' ? 'bg-green-50' : ($agenda->tipo_reuniao === 'presencial' ? 'bg-orange-50' : 'bg-purple-50')); ?> rounded-lg">
                                            <i class="fas fa-<?php echo e($agenda->tipo_reuniao === 'online' ? 'video' : ($agenda->tipo_reuniao === 'presencial' ? 'map-marker-alt' : 'users')); ?> <?php echo e($agenda->tipo_reuniao === 'online' ? 'text-green-600' : ($agenda->tipo_reuniao === 'presencial' ? 'text-orange-600' : 'text-purple-600')); ?> mr-3 text-lg"></i>
                                            <div>
                                                <p class="text-sm <?php echo e($agenda->tipo_reuniao === 'online' ? 'text-green-600' : ($agenda->tipo_reuniao === 'presencial' ? 'text-orange-600' : 'text-purple-600')); ?> font-medium">Tipo</p>
                                                <p class="<?php echo e($agenda->tipo_reuniao === 'online' ? 'text-green-800' : ($agenda->tipo_reuniao === 'presencial' ? 'text-orange-800' : 'text-purple-800')); ?> font-semibold"><?php echo e(ucfirst($agenda->tipo_reuniao)); ?></p>
                                            </div>
                                        </div>
                                        ...
                                        <?php if($agenda->participantes && count($agenda->participantes) > 0): ?>
                                            <div class="flex items-center p-3 bg-indigo-50 rounded-lg">
                                                ...
                                                <div>
                                                    <p class="text-sm text-indigo-600 font-medium">Participantes</p>
                                                    <p class="text-indigo-800 font-semibold"><?php echo e(count($agenda->participantes)); ?> pessoa(s)</p>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="flex items-center space-x-2 ml-4">
                                    <span class="status-badge status-<?php echo e($agenda->status); ?>"><?php echo e(ucfirst(str_replace('_', ' ', $agenda->status))); ?></span>
                                </div>
                            </div>
                            
                            <?php if($agenda->google_meet_link): ?>
                                <div class="mb-6">
                                    <a href="<?php echo e($agenda->google_meet_link); ?>" target="_blank" class="meet-link">
                                        <i class="fas fa-video mr-2"></i>
                                        Entrar no Google Meet
                                    </a>
                                </div>
                            ...
                            <div class="flex justify-end space-x-3 pt-4 border-t border-gray-100">
                                <button onclick="viewAgenda(<?php echo e($agenda->id); ?>)" class="btn-secondary">
                                    <i class="fas fa-eye"></i>
                                    Ver
                                </button>
                                <button onclick="editAgenda(<?php echo e($agenda->id); ?>)" class="btn-primary">
                                    <i class="fas fa-edit"></i>
                                    Editar
                                </button>
                                <?php if($agenda->status === 'agendada'): ?>
                                    <button onclick="toggleStatus(<?php echo e($agenda->id); ?>, 'em_andamento')" class="btn-success">
                                        <i class="fas fa-play"></i>
                                        Iniciar
                                    </button>
                                <?php elseif($agenda->status === 'em_andamento'): ?>
                                    <button onclick="toggleStatus(<?php echo e($agenda->id); ?>, 'concluida')" class="btn-warning">
                                        <i class="fas fa-check"></i>
                                        Concluir
                                    </button>
                                <?php endif; ?>
                                <button onclick="deleteAgenda(<?php echo e($agenda->id); ?>)" class="btn-danger">
                                    <i class="fas fa-trash"></i>
                                    Excluir
                                </button>
                            </div>
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/agenda.blade.php ENDPATH**/ ?>