...
<head>
    ...
    <title>Editar <?php echo e($template->name); ?> - DSPay</title>
...
<?php endif; ?>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm border-b">
                <div class="flex items-center justify-between px-6 py-4">
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(route('contract-templates.show', $template)); ?>" 
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 mt-1"><?php echo e($template->name); ?> • v<?php echo e($template->version); ?></p>
                        </div>
                    </div>
            ...
            <form action="<?php echo e(route('contract-templates.update', $template)); ?>" method="POST" class="max-w-6xl mx-auto">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                            ...
                            <div>
                                ...
                                <textarea id="description" 
                                          ...
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('description', $template->description)); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                            ...
                            <div class="p-6 pt-0">
                                <textarea id="content" 
                                          ...
                                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 font-mono text-sm"><?php echo e(old('content', $template->content)); ?></textarea>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                            ...
                            <div class="space-y-4">
                                <?php $__currentLoopData = $availableVariables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $variables): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div x-data="{ open: false }">
                                        <button type="button" 
                                            ...
                                            <span><?php echo e(strtoupper($category)); ?></span>
                                        ...
                                        <div x-show="open" x-collapse class="mt-2 space-y-1">
                                            <?php $__currentLoopData = $variables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $description): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="flex items-center justify-between p-2 text-xs border-l-2 border-gray-200 ml-2">
                                                    <div class="flex-1">
                                                        <div class="font-mono text-blue-600"><?php echo e($key); ?></div>
                                                        <div class="text-gray-500 mt-1"><?php echo e($description); ?></div>
                                                    </div>
                                                    <button type="button" 
                                                            @click="insertVariable('<?php echo e($key); ?>')"
                        ...
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                            ...
                            <div class="text-xs text-yellow-800 space-y-1">
                                <div><strong>Versão atual:</strong> <?php echo e($template->version); ?></div>
                                <div><strong>Contratos usando:</strong> <?php echo e($template->contracts_count ?? 0); ?></div>
                                <div><strong>Última atualização:</strong> <?php echo e($template->updated_at->format('d/m/Y H:i')); ?></div>
                                <hr class="my-2 border-yellow-300">
                                <p class="text-xs">• Se alterar o conteúdo, a versão será incrementada automaticamente</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function templateEditor() {
            return {
                content: `<?php echo e(old('content', str_replace(['\\', '"', "\n", "\r"], ['\\\\', '\\"', '\\n', '\\r'], $template->content))); ?>`,
                detectedVariables: [],
                showPreview: false,
                previewContent: '',
                ...
                detectVariables() {
                    ...
                    this.detectedVariables = [...new Set(matches.map(match => '<?php echo e(' + match[1] + '); ?>'))];
                },
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/contract-templates/edit.blade.php ENDPATH**/ ?>