                ...
                <div class="bg-gray-50 rounded-xl p-6 mb-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-600 font-medium"><?php echo e($agenda->titulo); ?></span>
                        </div>
                        
                        <?php if($agenda->descricao): ?>
                        <div class="flex items-start">
                            <i class="fas fa-align-left text-gray-400 w-5 mr-3 mt-1"></i>
                            <span class="text-gray-600"><?php echo e($agenda->descricao); ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-600">
                                <strong>Início:</strong> <?php echo e(\Carbon\Carbon::parse($agenda->data_inicio)->format('d/m/Y \à\s H:i')); ?>
                        ...
                        <div class="flex items-center">
                            <i class="fas fa-clock text-gray-400 w-5 mr-3"></i>
                            <span class="text-gray-600">
                                <strong>Fim:</strong> <?php echo e(\Carbon\Carbon::parse($agenda->data_fim)->format('d/m/Y \à\s H:i')); ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-600">
                                <strong>Organizador:</strong> <?php echo e($agenda->user->name ?? 'Sistema'); ?>
    ...
    <div class="bg-gray-800 text-white py-6 mt-12">
        <div class="container mx-auto px-4 text-center">
            <p class="text-gray-400">
                © <?php echo e(date('Y')); ?> Orbita. Sistema de Gestão de Reuniões e Agendas.
            </p>
        </div>
    </div>
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/agenda/confirmacao.blade.php ENDPATH**/ ?>