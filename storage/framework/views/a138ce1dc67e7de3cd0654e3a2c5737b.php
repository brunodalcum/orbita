            ...
            <main class="flex-1 overflow-y-auto p-6">
                <div class="container mx-auto px-4 py-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php $__empty_1 = true; $__currentLoopData = $campanhas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campanha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <!-- Campanha Dinâmica -->
                        <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex space-x-2">
                                    <button onclick="editCampanha(<?php echo e($campanha->id); ?>)" class="text-blue-600 hover:text-blue-900 p-1 rounded hover:bg-blue-100 transition-colors duration-200" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <?php if($campanha->status === 'ativa'): ?>
                                        <button onclick="pauseCampanha(<?php echo e($campanha->id); ?>)" class="text-yellow-600 hover:text-yellow-900 p-1 rounded hover:bg-yellow-100 transition-colors duration-200" title="Pausar">
                                            <i class="fas fa-pause"></i>
                                        </button>
                                    <?php elseif($campanha->status === 'pausada'): ?>
                                        <button onclick="resumeCampanha(<?php echo e($campanha->id); ?>)" class="text-green-600 hover:text-green-900 p-1 rounded hover:bg-green-100 transition-colors duration-200" title="Retomar">
                                            <i class="fas fa-play"></i>
                                        </button>
                                    <?php endif; ?>
                                    <?php if($campanha->status === 'rascunho'): ?>
                                        <button onclick="activateCampanha(<?php echo e($campanha->id); ?>)" class="text-green-600 hover:text-green-900 p-1 rounded hover:bg-green-100 transition-colors duration-200" title="Ativar">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800 mb-2"><?php echo e($campanha->nome); ?></h3>
                            <p class="text-sm text-gray-600 mb-3"><?php echo e($campanha->descricao ?: 'Sem descrição'); ?></p>
                            
                            <div class="space-y-3 mb-4">
                                <div class="flex justify-between text-sm">
                                    <span class="text-gray-500">Destinatários:</span>
                                    <span class="font-medium"><?php echo e($campanha->total_destinatarios); ?> <?php echo e($campanha->tipo === 'lead' ? 'leads' : ($campanha->tipo === 'licenciado' ? 'licenciados' : 'contatos')); ?></span>
                                </div>
                                <div class="flex justify-between text-sm">
                                    <span class="text-gray-500">Enviados:</span>
                                    <span class="font-medium text-green-600"><?php echo e($campanha->emails_enviados); ?></span>
                                </div>
                                <div class="flex justify-between text-sm">
                                    <span class="text-gray-500">Abertos:</span>
                                    <span class="font-medium text-blue-600"><?php echo e($campanha->taxa_abertura); ?>%</span>
                                </div>
                                <div class="flex justify-between text-sm">
                                    <span class="text-gray-500">Cliques:</span>
                                    <span class="font-medium text-purple-600"><?php echo e($campanha->taxa_clique); ?>%</span>
                                </div>
                            </div>
                            
                            <div class="flex space-x-2">
                                <button onclick="viewCampanha(<?php echo e($campanha->id); ?>)" class="flex-1 bg-blue-50 hover:bg-blue-100 text-blue-700 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
                                    <i class="fas fa-eye mr-1"></i>Ver Detalhes
                                </button>
                                <?php if($campanha->status === 'ativa'): ?>
                                    <button onclick="enviarCampanha(<?php echo e($campanha->id); ?>)" class="flex-1 bg-green-50 hover:bg-green-100 text-green-700 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
                                        <i class="fas fa-paper-plane mr-1"></i>Enviar
                                    </button>
                                <?php else: ?>
                                    <button onclick="duplicateCampanha(<?php echo e($campanha->id); ?>)" class="flex-1 bg-gray-50 hover:bg-gray-100 text-gray-700 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/marketing/campanhas.blade.php ENDPATH**/ ?>