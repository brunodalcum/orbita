            ...
            <form id="licenciadoForm" enctype="multipart/form-data">
                ...
                <div class="p-6 overflow-y-auto max-h-[60vh]">
                    ...
                    <div id="step3" class="step-content hidden">
                        ...
                        <p class="text-gray-600 mb-6">Selecione as operações que o licenciado poderá realizar:</p>
                    ...
                    <div id="step4" class="step-content hidden">
                        <div class="text-center">
                            ...
                            <p class="text-gray-600 mb-6">Confira as informações antes de finalizar o cadastro</p>
