        ...
        <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($leads->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-blue-600"><?php echo e($leads->where('status', 'novo')->count()); ?></p>
                </div>
                <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
        ...
        <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-600"><?php echo e($leads->where('status', 'qualificado')->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-purple-600"><?php echo e($leads->where('status', 'fechado')->count()); ?></p>
                </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-semibold text-sm">
                                    <?php echo e(strtoupper(substr($lead->nome, 0, 2))); ?>

                                </div>
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($lead->nome); ?></div>
                                    <?php if($lead->email): ?>
                                        <div class="text-sm text-gray-500"><?php echo e($lead->email); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($lead->empresa ?: 'N/A'); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($lead->telefone ?: 'N/A'); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full <?php echo e($lead->status_color); ?>">
                                <?php echo e(ucfirst($lead->status)); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <?php if($lead->licenciado): ?>
                                <div class="flex items-center">
                                    <div class="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center mr-2">
                                        <i class="fas fa-user text-green-600 text-xs"></i>
                                    </div>
                                    <div>
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($lead->licenciado->name); ?></div>
                                        <div class="text-xs text-gray-500"><?php echo e($lead->licenciado->email); ?></div>
                                    </div>
                                </div>
                            <?php else: ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($lead->origem ?: 'N/A'); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($lead->created_at->format('d/m/Y')); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($lead->created_at->format('H:i')); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                <button onclick="viewLead(<?php echo e($lead->id); ?>)" class="text-blue-600 hover:text-blue-900 p-1 rounded hover:bg-blue-100 transition-colors duration-200" title="Visualizar">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <button onclick="editLead(<?php echo e($lead->id); ?>)" class="text-green-600 hover:text-green-900 p-1 rounded hover:bg-green-100 transition-colors duration-200" title="Editar">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button onclick="assignLead(<?php echo e($lead->id); ?>)" class="text-indigo-600 hover:text-indigo-900 p-1 rounded hover:bg-indigo-100 transition-colors duration-200" title="Atribuir Licenciado">
                                    <i class="fas fa-user-plus"></i>
                                </button>
                                <button onclick="deleteLead(<?php echo e($lead->id); ?>)" class="text-red-600 hover:text-red-900 p-1 rounded hover:bg-red-100 transition-colors duration-200" title="Excluir">
                                    <i class="fas fa-trash"></i>
                                </button>
                                <button onclick="openFollowUpModal(<?php echo e($lead->id); ?>)" class="text-yellow-600 hover:text-yellow-900 p-1 rounded hover:bg-yellow-100 transition-colors duration-200" title="Follow-up">
                                    <i class="fas fa-phone"></i>
                                </button>
                                <button onclick="sendEmailMarketing(<?php echo e($lead->id); ?>)" class="text-purple-600 hover:text-purple-900 p-1 rounded hover:bg-purple-100 transition-colors duration-200" title="Email Marketing">
                                    <i class="fas fa-envelope"></i>
                                </button>
                                <button onclick="toggleLeadStatus(<?php echo e($lead->id); ?>)" class="text-gray-600 hover:text-gray-900 p-1 rounded hover:bg-gray-100 transition-colors duration-200" title="<?php echo e($lead->ativo ? 'Desativar' : 'Ativar'); ?>">
                                    <i class="fas fa-<?php echo e($lead->ativo ? 'check-circle' : 'times-circle'); ?>"></i>
                                </button>
                            </div>
                        </td>
                    </tr>
...
function sendEmail(event) {
    ...
    fetch('<?php echo e(route("leads.send-marketing-email")); ?>', {
        method: 'POST',
        headers: {
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/leads.blade.php ENDPATH**/ ?>