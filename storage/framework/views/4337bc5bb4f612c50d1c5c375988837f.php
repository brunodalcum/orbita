                    ...
                    <div class="d-flex align-items-center">
                        <div class="glass-container px-4 py-3">
                            <div class="text-white text-center">
                                ...
                                <h4 class="mb-1"><?php echo e($totalLeads); ?></h4>
    ...
    <div class="row mb-5 g-4">
        <div class="col-lg-3 col-md-6">
            <div class="stat-card">
                ...
                <h3 class="fw-bold mb-2"><?php echo e($totalLeads); ?></h3>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="stat-card">
                ...
                <h3 class="fw-bold mb-2"><?php echo e($leadsAtivos); ?></h3>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="stat-card">
                ...
                <h3 class="fw-bold mb-2"><?php echo e($leadsComLicenciado); ?></h3>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="stat-card">
                ...
                <h3 class="fw-bold mb-2"><?php echo e($leadsSemLicenciado); ?></h3>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 text-center">
                            <div class="p-4">
                                ...
                                <a href="<?php echo e(route('dashboard.places.extract')); ?>" 
    ...
    <div class="row">
        <div class="col-12">
            <div class="modern-form">
                ...
                <form id="exportForm" method="POST" action="<?php echo e(route('dashboard.leads.export')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" class="form-select">
                                ...
                                <?php $__currentLoopData = $leadsPorStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($status); ?>"><?php echo e(ucfirst($status)); ?> (<?php echo e($count); ?>)</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="origem" class="form-select">
                                ...
                                <?php $__currentLoopData = $leadsPorOrigem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $origem => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($origem); ?>"><?php echo e($origem); ?> (<?php echo e($count); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="licenciado" class="form-select">
                                ...
                                <option value="com_licenciado">Apenas com licenciado (<?php echo e($leadsComLicenciado); ?>)</option>
                                <option value="sem_licenciado">Apenas sem licenciado (<?php echo e($leadsSemLicenciado); ?>)</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="ativo" class="form-select">
                                ...
                                <option value="1">Apenas ativos (<?php echo e($leadsAtivos); ?>)</option>
                                <option value="0">Apenas inativos (<?php echo e($totalLeads - $leadsAtivos); ?>)</option>
                            </select>
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <a href="<?php echo e(route('dashboard.leads')); ?>" class="btn btn-modern btn-outline-modern w-100">
...
<?php /**PATH /Applications/MAMP/htdocs/orbita/resources/views/dashboard/leads/extract.blade.php ENDPATH**/ ?>